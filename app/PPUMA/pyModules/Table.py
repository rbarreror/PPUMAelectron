...
def readInfile(infile, row):
    ...
    try:
        ...
        sys.exit(3) # Status code for column name error
        ...
        sys.exit(2) # Status code for file format
...
def addTaggerColumns(df_columns, compare_column):
    ...
    candidate_tagger_columns = ['Food', 'Drug', 'NaturalProduct', 'Halogenated', 'Microbial']
...
if __name__=="__main__":
    ...
    default_compare_columns = "1, 3, 4, 5" #Tagger columns are added in function "addTaggerColumns"
